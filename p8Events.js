...
async function maintainEventNumbers(request) {
    /*
        ...
        NOTE that the adjustments can vary from 1 - 4

    */
    let adjustments = request.adjustments;
    const ADJ_REGISTRATIONS = request.adjustments.hasOwnProperty(
        'registrationCount'
    );
    ...
    if (ADJ_REGISTRATIONS) {
        ...
        if (parseInt(WAS_REGISTRATIONS) + DELTA_REGISTRATIONS < 1) {
            ...
            workingEvent.registrations =
                parseInt(WAS_REGISTRATIONS) + DELTA_REGISTRATIONS;
        }
    }
    if (ADJ_MEAL_PLAN) {
        ...
        if (parseInt(WAS_MEAL_PLAN) + DELTA_MEAL_PLAN < 1) {
            ...
            workingEvent.meal.mealCount =
                parseInt(WAS_MEAL_PLAN) + DELTA_MEAL_PLAN;
        }
    }
    if (ADJ_ATTENDANCE) {
        ...
        if (parseInt(WAS_ATTENDANCE) + DELTA_ATTENDANCE < 1) {
            ...
            workingEvent.attendance =
                parseInt(WAS_ATTENDANCE) + DELTA_ATTENDANCE;
        }
    }
    if (ADJ_MEALS_FED) {
        ...
        if (parseInt(WAS_MEALS_FED) + DELTA_MEALS_FED < 1) {
            ...
            workingEvent.meal.mealsServed =
                parseInt(WAS_MEALS_FED) + DELTA_MEALS_FED;
        }
    }
